...
public class TaskService {
    ...
    public void addTask(Task task) {
        ...
        } catch (TaskRepoOverflowException | TaskExistsException | SQLException e) {
    ...
    public void deleteTask(int id) {
        ...
        } catch (TaskNotExistException | SQLException e) {
            e.printStackTrace();
        }
    }

    public void printTaskList() throws SQLException {
    ...
    public long getTaskCountFilterByStatus(TaskStatus status) throws SQLException {
    ...
    public long getTaskCountFilterByStatus(TaskStatus... statuses) throws SQLException {
        return taskRepository.getTaskCountFilterByStatus(statuses);
    }
